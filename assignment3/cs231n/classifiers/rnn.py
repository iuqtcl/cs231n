...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        dh,grads['W_vocab'],grads['b_vocab']=temporal_affine_backward(dh,tem_affine_cache)
        x,dh0,grads['Wx'],grads['Wh'],grads['b']=rnn_backward(dh,rnn_cache)
        grads['W_embed']=word_embedding_backward(x,embed_cache)
        _,grads['W_proj'],grads['b_proj']=affine_backward(dh0,affine_cache)


        #grads['x'],grads['h0'],grads['Wx'],grads['Wh'],grads['db']=rnn_backward(dh,cache)
